...
import (
	...
	"github.com/nebucloud/nebucloud-xds-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(xdsv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "50095edc.xds.nebucloud.io",
